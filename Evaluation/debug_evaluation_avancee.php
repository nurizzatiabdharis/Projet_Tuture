...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
	...
	<title>Correction Evaluation Avancée</title>
</head>
		<body>
	<?php include('../outils/menu.php');?>
		<div id=corps>
			<section>
				<p><h1> Correction Evaluation Avancée </h1></p>
		<?php

						$niveau_evaluation = 'avance';
            $nb_reponses_totales = 15;
          ...
          ?>
		<br><br><input id=exoeva type="button" value="Refaire la question" onclick="window.location.href='./evaluation_avancee.php'">
