...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
	...
	<?php include('../outils/menu.php');?>
		<div id=corps>
			<section>
				<p><h1>Exercice vocabulaire 2</h1></p>
				<h3>Choisissez la reponse qui correspondent à l'audio</h3>
		<?php
			include("../outils/base.php");
			$sql = "SELECT * FROM exo WHERE support='audio' AND class='qcm' AND type='exo_vocab'";
			$req = $bd->prepare($sql);
			$req->execute();
			$test=$req->fetchall();
			$req->closeCursor();
		...
		echo "<form method='post' action='debug_exo_vocab_audio.php'>";
